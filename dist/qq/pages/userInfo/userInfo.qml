<view class="container  cml-base cml-view">
  ...
  <view class="containerBox  cml-base cml-view">
    <row justify="start" margin="{{40}}" class="rowstyle  cml-base cml-row">
    ...
    <row justify="start" margin="{{40}}" class="rowstyle rowpick  cml-base cml-row">
    ...
    <row justify="start" margin="{{40}}" class="rowstyle  cml-base cml-row">
      ...
      <row style="flex:3" class=" cml-base cml-row">
